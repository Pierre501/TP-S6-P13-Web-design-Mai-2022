...
$facteurs = $facteur->getSimpleFacteurs($_SESSION['id']);
$tabTypeConsequence = $view->getAllTypeConsequenceAvecFiltre($facteurs->getFacteurs());
$tabDetailsConsequence = $view->getAllDetailsConsequence($facteurs->getConsequence());
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Modifier une contenue</h1>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    <p style="color: red;"><?php if(isset($_GET['erreur'])) { echo "Oups! Veiullez réessayez s'il vous plait!"; } ?></p>
                        <form action="modification-<?php echo $facteurs->getUrl(); ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Facteurs</label>
                                <input class="form-control" type="text" name="facteurs" value="<?php echo $facteurs->getFacteurs(); ?>">
                            </div>
                            <div class="form-group">
                                <label>Type conséquence</label>
                                <select class="form-control" name="consequence">
                                    <?php foreach($tabTypeConsequence as $typeConsequence) { ?>
                                        <option value="<?php echo $typeConsequence->getIdConsequence(); ?>"><?php echo $typeConsequence->getTypeConsequence(); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="details" rows="10">
                                    <?php foreach($tabDetailsConsequence as $detailsConsequence) { ?>
                                        <?php echo $detailsConsequence->getDetailsConsequence(); ?>
                                    <?php } ?>
                                </textarea>
                            </div>
